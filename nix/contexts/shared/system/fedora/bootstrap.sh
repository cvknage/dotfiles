...
PACKAGES=(
  ...
  # Work-only: Red Hat IdM client; ipa-client-install itself stays manual
  # (needs a personal enrollment password from IT)
  freeipa-client
)
...
# System Manager's nix.enable is false here (see ./default.nix), so nothing
