...
If the resumed plan needs revising, call `revise_plan` (mcp__sessions__revise_plan), never `write_plan` — the latter archives notes.md, discarding everything recorded for this task.