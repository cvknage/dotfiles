---
name: reindex-code-graph
description: Diagnose and refresh a stale or empty code-graph index. Invoked by the user as /reindex-code-graph, or when semantic_code_search/ast_search return empty or stale-looking results.
---
